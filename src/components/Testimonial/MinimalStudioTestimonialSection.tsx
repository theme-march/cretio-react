...
import CreativeTestimonialItem from "./CreativeTestimonialItem";
...
const MinimalStudioTestimonialSection: React.FC = () => {
    ...
    return (
        <section className="ak-black-bg overflow-hidden">
            <div className="testmonial-area ak-parallax">
                ...
                <div className="testmonial-wrapper style2">
                            ...
                            >
                                {testimonials.map((item) => (
                                    <SwiperSlide key={item.id}>
                                        <CreativeTestimonialItem testimonial={item} />
                                    </SwiperSlide>
                                ))}
                            </Swiper>
                        </div>
...
export default MinimalStudioTestimonialSection;
