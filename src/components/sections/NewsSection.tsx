    ...
    return (
        <section>
            ...
            <div className="news-swiper-controller">
                <div className="news-logs-scrollbar"></div>
                <div className="news-logs-navigation">
                    <div className="news-logs-button-prev">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="10" viewBox="0 0 28 10" fill="none">
                            <g clipPath="url(#clip0_220980978972_379)">
                                <path
                            ...
                            <defs>
                                <clipPath id="clip0_220980978972_379">
                                    <rect width="27" height="9" fill="white" transform="matrix(-1 0 0 1 27.4551 0.949463)" />
                                </clipPath>
                            </defs>
                        </svg>
                    </div>
                    <div className="news-logs-button-next">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="10" viewBox="0 0 28 10" fill="none">
                            <g clipPath="url(#clip0_2272_3654676)">
                                <path
                            ...
                            <defs>
                                <clipPath id="clip0_2272_3654676">
            ...
            <div className="container fade-animation" data-delay="0.35">
                <div className="mt-4 ak-slider ak-news-slider">
                    <Swiper
                    ...
                    >
                        {newsItems.map((item) => (
                            <SwiperSlide key={item.id} className="p-0">
                                <Link to="/blog-details" className="news-card">
