...
interface CreativeNewsSectionProps {
    title?: string;
    highlightWords?: string[];
}

const CreativeNewsSection: React.FC<CreativeNewsSectionProps> = ({ 
    title = "Our Exceptional Digital Industrial News",
    highlightWords = ["Exceptional", "News"],
}) => {
    const prefix = "news-blog";
    const sliderClass = "ak-news-blog-slider";
    ...
    return (
        <section>
            ...
            <div className="news-blog-swiper-controller">
...
export default CreativeNewsSection;
