...
const PortfolioDetailsBreadcrumb: React.FC = () => {
    const title = "Our Exceptional Successful Development Project";
    const highlightWords = ["Exceptional", "Project"];
    const links = [
        { label: "Home", path: "/" },
    ...
    return (
        <>
            ...
            <div className="breadcrumb-area style-2">
                ...
                <div className="breadcrumb-stroke ">Project</div>
            </div>
        </>
    );
};

export default PortfolioDetailsBreadcrumb;
