...
const BlogBreadcrumb: React.FC = () => {
    const title = "Our Exceptional Digital Industrial Recent News";
    const highlightWords = ["Exceptional", "News"];
    const links = [{ label: "Home", path: "/" }, { label: "Blog", path: "" }];
    ...
    return (
        <>
            ...
            <div className="breadcrumb-area style-2">
                ...
                <div className="breadcrumb-stroke text-normal">Articles</div>
            </div>
        </>
    );
};
