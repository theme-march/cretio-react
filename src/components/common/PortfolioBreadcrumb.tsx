...
const PortfolioBreadcrumb: React.FC = () => {
    const title = "Our Exceptional Successful Development Projects";
    const highlightWords = ["Exceptional", "Projects"];
    const links = [{ label: "Home", path: "/" }, { label: "Portfolio", path: "/portfolio" }];
    ...
    return (
        <>
            ...
            <div className="breadcrumb-area style-2">
                ...
                <div className="breadcrumb-stroke ">PORTFOLIO</div>
            </div>
        </>
    );
};
