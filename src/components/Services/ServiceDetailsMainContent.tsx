...
const ServiceDetailsMainContent: React.FC = () => {
    const [activeAccordion, setActiveAccordion] = useState<number | null>(0);
    const tabRefs = useRef<(HTMLDivElement | null)[]>([]);

    const accordionData = detailsDataDefault.serviceDetails.accordion;
            ...
            <section className="container">
                <div className="services-short-info">
                    <div className="services-short-info-content">
                        {detailsDataDefault.serviceDetails.shortInfo.map((info: { label: string; text: string }, idx: number) => (
...
export default ServiceDetailsMainContent;
